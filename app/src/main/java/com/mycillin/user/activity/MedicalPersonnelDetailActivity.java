...
public class MedicalPersonnelDetailActivity extends AppCompatActivity {
    ...
    @BindView(R.id.medicalPersonnelDetailActivity_tv_doctorName)
    TextView doctorName;
    @BindView(R.id.medicalPersonnelDetailActivity_tv_doctorType)
    TextView doctorType;
    @BindView(R.id.medicalPersonnelDetailActivity_tv_doctorPermitt)
    TextView doctorPermitt;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_medical_personnel_detail);
